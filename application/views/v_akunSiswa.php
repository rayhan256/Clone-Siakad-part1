    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <span class="navbar-text">
                <h6 class="nav-link text-white">Hello, <?= $this->session->userdata('nama');?> 😎</h6>
            </span>
            <span class="navbar-text">
                <a href="<?= base_url('login/v_signUpSiswa') ?>"><button class="btn btn-danger">
                        Log Out
                    </button></a>
            </span>
        </div>
    ...
    <div class="container">
        <section id="content">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p>Mulai tanggal 16 Maret 2020, seluruh mahasiswa kampus wowong akan diliburkan dikarenakan<br> wabah virus corona yang sudah mulai merebak di indonesia. System perkuliahan akan dilaksanakan dalam bentuk online </p>
                </div>
            </div>
            <section id="content">
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <p>Sidang akan dilaksanakan pada akhir bulan November 2020, dan tiap mahasiswa harus sedia duit<br> sebanyak-banyaknnya buat mbayar SPP. Jika belum lunas maka gak akan lulus aslinaaaaaa.
                            <br>
                            <br>
                            <br>
                            Karena ada kasus korona maka sidang di universitas wowong akan diundur 3 tahun sampai satu dunia gak ada korona lagi. Happy Liburan guyssss
                        </p>
                    </div>
                </div>
            </section>
